...
export default {
    ...
    //初始化
        ...
        //设置屏幕的宽高
        const screenW = screen.getPrimaryDisplay().workAreaSize.width * 0.9; //屏幕最大的宽度
        const screenH = screen.getPrimaryDisplay().workAreaSize.height * 0.9; let //屏幕最大的高度
            width = 640; //初始化宽度
        let height = 640; //初始化高度
